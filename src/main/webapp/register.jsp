...
<html>
    ...
    <div class="d-flex justify-content-center align-items-center">
        <div class="container">
            ...
            <h2 class="h2 my-3 font-weight-normal">Register</h2>
            <form method="POST" action="processRegister.jsp" class="form-container">
                <div class="mb-3">
                ...
                <p><a class="btn btn-sm btn-outline-secondary btn-block" href="login.jsp">Login</a></p>
            </form>
